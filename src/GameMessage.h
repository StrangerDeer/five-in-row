...
public:
    ...
    const string columnQuestion = "How many columns would you like to play with?";
    const string rowQuestion = "How many rows would you like to play with?";
    ...
    string wonMessage(const string& winningPlayerName);
